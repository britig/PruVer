...
'''
    ...
    Safety Requirement
    # Requirement 1: The hull angle > 0
'''
...
def run_test(policy):
    ...
    for i in range(100):
        ...
        if(ep_rew<0):
            ...
            traj_spec_dic[traj_count] = (traj,ep_rew,selected_seed,act_list)
            traj_count = traj_count + 1
...
if __name__ == '__main__':
    ...
    env.seed(seed)
    selected_seed = env.seed(None)
    actor_model = 'ppo_actorBipedalWalker-v3_0.5.pth'
    ...
    with open('counterexample_trajectory_bipedal.data', 'wb') as filehandle1:
